...
In this dataset, I specifically aim to investigate if (1) female entrepreneurs are represented as often as male entrepreneurs in the show, (2) if female entrepreneurs ask for similar amounts of investment, valuation, and equity in their businesses as male entrepreneurs, (3)female entrepreneurs receive investment as often as male entrepreneurs, (4) if that investment aligns with their initial demands (i.e. quality of investment), (5) which sharks invest in female entrepreneurs more often, and (6) if specific sharks undervalue businesses started by women compared to men. Additionally, I plan to investigate (7) which types of businesses attract more female entreprenurs, (8) if these businesses receive investment as often by investors, and (9) which sharks invest most often in these industries. Follow-up studies may be done to see how these trends change over time. Perhaps in the years the show has been on the air the treatment of female entrepreneurs has changed or the investment trends of sharks has changed. Additionally, I might conduct further study to see if a male partner improves female entrepreneur investment outcomes and if a female partner worsens male entrepreneur investment outcomes.

## Initial Analyses

![Gender Ratios Plot](plots/gender_ratios_plot.png)

In the plot above^[Relates to research question number 1], it is clear that female entrepreneurs and all female teams are underrepresented when compared to male entrepreneurs and all male teams. Mixed teams are underrepresented when compared to both. There seems to be some bias in the gender balance of the show, which is to be expected since female entrepreneurs tend to face more obstacles in building their businesses and are underrepresented in leadership positions.

![Businesses Types Represented](plots/businesses_represented_plot.png)
In the plot above^[Relates to research question number 7], it is seen that Food/Beverage, Fashion/Beauty, and Lifestyle/Home are represented the most. Some of these industries tend to be more associated with stereotypical "feminine" interests like Fashion and Beauty. Further investigation should be conducted to see if there is a bias for more female entrepreneurs to work in these industries. 

![Typical Valuation Requested](plots/typical_valuation_plot.png)
In the plot above^[Relates to research question number 2 and 4], it is seen that the typical requested valuation is approximately 1,500,000 USD, with a slight skew to the right. The lowest requested was 40,000 and the highest 100,000,000 USD. Further analysis will be conducted to determine how these amounts vary by gender, but it is important to understand what valuations are typical for this group.


![Typical Investment Received](plots/typical_investment_plot.png)
In the plot above^[Relates to research question number 2 and 4], it is seen that the typical investment received (for those that received deals) was approximately 200,000 USD, with a slight skew to the right. The lowest amount invested was 10,000 and the highest 5,000,000 USD. Further analysis will be conducted to determine how these amounts vary by gender, but it is important to understand what types of investments and what amounts are typical for this group.

![Typical Equitites Received](plots/typical_equity_plot.png)
In the plot above^[Relates to research question number 2 and 4], it is seen that the typical equity received (for those that received deals) was approximately 20 percent, with a slight skew to the right. The lowest amount invested was 2 percent and the highest 100 percent (indicating that the shark bought the company outright). Further analysis will be conducted to determine how these amounts vary by gender.

Further analyses will be conducted to see how the details of each deal differ from what was originally requested and how that varies by gender. Further analysis will be conducted to investigate individual shark's behavior and how they tend to treat male vs. female vs. mixed team entrepreneurs. 

## Misc and Self-Assessment

There is still quite a bit to do in getting this project together. I have completed some univariate analyses general distributions of gender, types of businesses, and typical investment amounts and equities seen for each investment. I next plan to investigate the relationships between shark, the entrepreneur's gender, their business, and quality of investment received. These will require bivariate and multivariate analyses. I will also conduct further analyses on perhaps how these trends have changed over time. Additional data cleaning might be required although I do not anticipate needing it at this time. 
