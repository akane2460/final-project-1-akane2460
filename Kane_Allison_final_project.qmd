...
#### Barbara Corcoran
![Barbara Corcoran](plots/bc_invest_frequency.png)
In @fig-23, Barbara Corcoran makes deals approximately 9.3% of the time when pitched to, passing on 90.7% of pitches.

#### Mark Cuban
![Mark Cuban](plots/mc_invest_frequency.png)
In @fig-24, Mark Cuban makes deals approximately 18.1% of the time when pitched to, passing on 81.9% of deals.

#### Lori Greiner
![Lori Greiner](plots/lg_invest_frequency.png)
According to @fig-25, Lori Greiner makes deals approximately 15.6% of the time when pitched to, passing on 84.4% of deals.

#### Robjert Herjavec
![Robert Herjavec](plots/rh_invest_frequency.png)
In @fig-26, Robert Herjavec makes deals approximately 9.6% of the time when pitched to, passing on 90.4% of deals.

#### Daymond John
![Daymond John](plots/dj_invest_frequency.png)
According to @fig-27, Daymond John makes deals approximately 8.8% of the time when pitched to, passing on 91.2% of deals.

#### Kevin O'Leary
![Kevin O'Leary](plots/kol_invest_frequency.png)
In @fig-28, Kevin O'Leary makes deals approximately 9.2% of the time when pitched to, passing on 90.8% of deals.

Overall, when pitched to most sharks make deals less than 10% of the time, with the exception of Mark Cuban (18.1%) and Lori Greiner (15.6%). Daymond John makes deals the least often (8.8% percent of pitches). However, of the deals made, how many of them are women-run businesses? Are male investors less likely to make deals with women? 
...
In @fig-29, it is clear that female sharks-- including female guests, Barbara Corcoran and Lori Greiner--invest in women more often than male sharks. These differences are likely not due to differences in frequency of investing. Even when compared to sharks that invest similar amounts, female sharks invest more often in female-run businesses than male sharks. 
...
![Industries Invested in by Female Sharks](plots/industries_preferred_female_sharks_plot.png)

![Industries Invested in by Male Sharks](plots/industries_preferred_male_sharks_plot.png)
